          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <button 
                ...
                className="text-gray-600 hover:text-violet transition-colors duration-300 hover:scale-105"
              >
                Fonctionnalités
              </button>
              <button 
              ...
              >
                <Button 
                  ...
                  className="bg-violet hover:bg-violet/90 transition-all duration-300"
                >
                  Se Connecter
                </Button>
              </motion.div>
              ...
              >
                ...
                >
                  <Button 
                    size="lg"
                    onClick={() => navigate('/auth')}
                    className="bg-violet hover:bg-violet/90 text-lg px-8 py-4 shadow-lg hover:shadow-xl transition-all duration-300"
                  >
                ...
                >
                  <Button 
                    size="lg"
                    variant="outline"
                    className="border-violet text-violet hover:bg-violet hover:text-white text-lg px-8 py-4 shadow-lg hover:shadow-xl transition-all duration-300"
                  >
        ...
        <div className="container mx-auto text-center">
          ...
          >
            <Button 
              size="lg"
              onClick={() => navigate('/auth')}
              className="bg-white text-violet hover:bg-white/90 text-lg px-8 py-4 shadow-xl hover:shadow-2xl transition-all duration-300"
            >
